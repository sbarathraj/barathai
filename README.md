...
│   │   ├── 📄 AnimatedThemeToggle.tsx      # Professional theme switcher
│   │   ├── 📄 ThemeProvider.tsx            # Global theme management
│   │   ├── 📄 UserManagementTab.tsx        # Admin user management
│   │   ├── 📄 UsageAnalytics.tsx           # Real-time analytics
│   │   ├── 📄 ProfessionalImageGallery.tsx # Image gallery system
│   │   ├── 📄 ProfessionalImageViewer.tsx  # Image viewing interface
│   │   ├── 📄 ImageGenerationTrackingTab.tsx # Image generation logs
│   │   ├── 📄 ApiTrackingTab.tsx           # API usage tracking
...
│   │   ├── 📄 Settings.tsx        # User settings & admin panel
│   │   ├── 📄 Admin.tsx           # Admin dashboard
│   │   └── 📄 SettingsDemo.tsx    # Feature demonstration
│   ├── 📁 hooks/                  # Custom React Hooks
│   │   ├── 📄 useRealtimeUsage.ts # Real-time analytics hook
