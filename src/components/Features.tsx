...
import { Mic, Clock, Shield, Brain, Zap, ImageIcon, Sparkles, Globe, Users } from "lucide-react";
...
export const Features = () => {
  return (
    <section id="features" className="py-32 px-4 bg-gradient-to-br from-violet-50 via-pink-50 via-cyan-50 to-emerald-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 transition-colors duration-500 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-20 right-20 w-[20rem] h-[20rem] bg-gradient-to-br from-emerald-300/15 via-teal-300/10 to-blue-300/15 rounded-full blur-2xl animate-float-slow" style={{ animationDelay: '3s' }} />
        <div className="absolute bottom-20 left-20 w-[18rem] h-[18rem] bg-gradient-to-br from-orange-300/12 via-yellow-300/8 to-red-300/12 rounded-full blur-xl animate-float-medium" style={{ animationDelay: '5s' }} />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-24">
          ...
          <p className="text-2xl text-slate-600 dark:text-slate-300 max-w-4xl mx-auto animate-fade-in delay-200 leading-relaxed">
            Experience the next generation of AI conversation with features designed for 
            <span className="text-violet-600 dark:text-violet-400 font-semibold"> productivity</span>, 
            <span className="text-pink-600 dark:text-pink-400 font-semibold"> creativity</span>, and 
            <span className="text-cyan-600 dark:text-cyan-400 font-semibold"> seamless interaction</span>.
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              <CardContent className="p-10 text-center flex flex-col items-center gap-6 relative overflow-hidden">
                ...
                {/* Icon container */}
                <div className={`relative z-10 p-4 bg-gradient-to-r ${feature.gradient} rounded-2xl shadow-xl group-hover:shadow-2xl transition-all duration-500 group-hover:scale-110`}>
          ...
          <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl p-12 shadow-2xl border-2 border-white/50 dark:border-slate-700/50">
            <div className="flex flex-wrap items-center justify-center gap-6 mb-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-slate-800 dark:text-slate-100">10K+</div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-slate-800 dark:text-slate-100">50+</div>
