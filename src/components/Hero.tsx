...
import { ArrowRight, MessageCircle, Sparkles, Zap, Brain, ShieldCheck, Users, ImageIcon, Star, Rocket, Globe } from "lucide-react";
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto flex flex-col items-center">
        ...
        <div className="space-y-6 mb-10">
          <div className="relative">
            ...
            {/* Subtle glow effect */}
            <div className="absolute inset-0 text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black leading-tight bg-gradient-to-r from-cyan-400 via-violet-400 via-pink-400 to-orange-400 bg-clip-text text-transparent opacity-20 blur-sm animate-gradient-text" style={{ animationDelay: '0.5s' }}>
              BarathAI
            </div>
          </div>
            ...
            {[...Array(5)].map((_, i) => (
              <Star 
                ...
                className={`w-5 h-5 animate-pulse ${
                  i % 5 === 0 ? 'text-cyan-400' :
                  i % 5 === 1 ? 'text-violet-400' :
                  i % 5 === 2 ? 'text-pink-400' :
                  i % 5 === 3 ? 'text-orange-400' :
                  'text-emerald-400'
                }`}
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold animate-fade-in delay-300">
            <span className="bg-gradient-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent">Your</span>{' '}
            <span className="bg-gradient-to-r from-violet-500 to-purple-500 bg-clip-text text-transparent">Smartest</span>{' '}
            <span className="bg-gradient-to-r from-pink-500 to-rose-500 bg-clip-text text-transparent">Assistant</span>
          </h2>
        </div>
        ...
        <div className="mb-10 animate-fade-in delay-300">
          <p className="text-xl sm:text-2xl md:text-3xl text-slate-600 dark:text-slate-300 font-medium tracking-wide leading-relaxed max-w-4xl mx-auto">
            Converse with AI. <span className="text-violet-600 dark:text-violet-400 font-bold">Boost productivity.</span> <span className="text-pink-600 dark:text-pink-400 font-bold">Unlock creativity.</span>
          </p>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-10 animate-fade-in delay-500 px-4">
          {[
            { icon: Brain, label: "AI Powered", color: "from-emerald-400 via-teal-500 to-cyan-500", bgColor: "from-emerald-500/10 to-cyan-500/10", delay: "delay-500" },
            { icon: Zap, label: "Lightning Fast", color: "from-yellow-400 via-orange-500 to-red-500", bgColor: "from-yellow-500/10 to-red-500/10", delay: "delay-700" },
            { icon: Sparkles, label: "Intelligent", color: "from-violet-400 via-purple-500 to-pink-500", bgColor: "from-violet-500/10 to-pink-500/10", delay: "delay-1000" },
            { icon: ShieldCheck, label: "Private & Secure", color: "from-blue-400 via-indigo-500 to-purple-500", bgColor: "from-blue-500/10 to-purple-500/10", delay: "delay-1200" },
            { icon: ImageIcon, label: "Image Generation", color: "from-pink-400 via-rose-500 to-red-500", bgColor: "from-pink-500/10 to-red-500/10", delay: "delay-1400" },
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-r ${bgColor} opacity-0 group-hover:opacity-100 transition-opacity duration-300`} />
              
              <div className={`relative z-10 p-1.5 rounded-lg bg-gradient-to-r ${color} shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110`}>
                <Icon className="h-3 w-3 text-white" />
              </div>
              <span className="relative z-10 text-xs font-bold text-slate-700 dark:text-slate-200 group-hover:text-slate-800 dark:group-hover:text-white transition-colors duration-300">{label}</span>
        ...
        <div className="animate-fade-in delay-1000 px-4">
          <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/50 dark:border-slate-700/50 relative overflow-hidden">
            ...
            <div className="relative z-10 grid grid-cols-1 sm:grid-cols-3 gap-8">
              {[
                { icon: Users, value: "10K+", label: "Active Users", gradient: "from-emerald-500 to-teal-500" },
                { icon: ShieldCheck, value: "99.9%", label: "Uptime", gradient: "from-violet-500 to-purple-500" },
                { icon: Globe, value: "24/7", label: "Support", gradient: "from-cyan-500 to-blue-500" },
                ...
                <div key={label} className="flex flex-col items-center space-y-4 group">
                  ...
                  <div className={`text-4xl font-black bg-gradient-to-r ${gradient} bg-clip-text text-transparent group-hover:scale-105 transition-transform duration-300`}>
                    {value}
                  </div>
